  ...
  if (children.length === 0) {
    return (
      <p className="text-xs text-muted-foreground">
        {t("components.caseChildrenTree.emptyState", { defaultValue: "No child cases." })}
      </p>
    );
  }
    ...
    <div className="space-y-1">
          ...
          <li key={child.id}>
            ...
            >
              <CaseCopyableToken
                ...
                label={t("components.caseChildrenTree.caseIdLabel", { defaultValue: "case ID" })}
      ...
      {hiddenCount > 0 ? (
        ...
        >
          ...
          {t("components.caseChildrenTree.showMore", { defaultValue: "Show {{count}} more", count: hiddenCount })}
        </Button>
      ) : null}
    </div>
  );
