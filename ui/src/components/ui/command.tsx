...
function CommandDialog({
  ...
  const resolvedTitle = title ?? t("components.commandDialog.title", { defaultValue: "Command Palette" })
  const resolvedDescription = description ?? t("components.commandDialog.description", { defaultValue: "Search for a command to run..." })
