            ...
            {!isMobile && !collapseLocked ? (
              peeking ? (
                <Button
                  ...
                  size="icon-sm"
                  className="text-muted-foreground shrink-0"
                  aria-label={t("nav.keepSidebarExpanded", { defaultValue: "Keep sidebar expanded" })}
                  title={t("nav.keepSidebarExpanded", { defaultValue: "Keep sidebar expanded" })}
                ...
                <Button
                  ...
                  title={collapsed ? t("nav.expandSidebar", { defaultValue: "Expand sidebar" }) : t("nav.collapseSidebar", { defaultValue: "Collapse sidebar" })}
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 pointer-coarse:gap-3 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem
            ...
            badgeLabel={t("nav.unread", { defaultValue: "unread" })}
          ...
          {showDecisions ? (
            <SidebarNavItem
              ...
              badgeLabel={t("nav.decisions", { defaultValue: "decisions" })}
            />
          ) : null}
        ...
        <SidebarSection label={t("nav.work", { defaultValue: "Work" })} collapsible={{ open: workOpen, onOpenChange: setWorkOpen }}>
        ...
        <SidebarSection label={t("nav.company", { defaultValue: "Company" })} collapsible={{ open: companyOpen, onOpenChange: setCompanyOpen }}>
