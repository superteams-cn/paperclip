          ...
          <span className="text-xs text-muted-foreground">
            {trigger.kind === "schedule" && trigger.nextRunAt
              ...
              : trigger.kind === "webhook"
                ? t("components.routineTriggerCard.webhookStatus", { defaultValue: "Webhook" })
                : t("components.routineTriggerCard.apiStatus", { defaultValue: "API" })}
          </span>
        </div>
      </div>
      ...
      {!disabled && (
        <div className="flex flex-wrap items-center justify-end gap-2">
          ...
          >
            ...
            {t("components.routineTriggerCard.saveButton", { defaultValue: "Save trigger" })}
          </Button>
        </div>
      )}
    </form>
