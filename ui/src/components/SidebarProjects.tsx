...
function ProjectItem({
  ...
  const link = (
    ...
    >
      ...
      {!rail && project.pauseReason === "budget" ? <BudgetSidebarMarker title={t("sidebar.projects.pausedByBudget", { defaultValue: "Project paused by budget" })} /> : null}
    </NavLink>
  );
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              ...
              aria-label={t("sidebar.projects.openActions", { name: project.name, defaultValue: "Open actions for {{name}}" })}
            >
          ...
          <DropdownMenuContent align="end" className="w-44">
            ...
            >
              ...
              <span>{leaving ? t("sidebar.projects.leaving", { defaultValue: "Leaving..." }) : t("sidebar.projects.leaveProject", { defaultValue: "Leave project" })}</span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
        )}
