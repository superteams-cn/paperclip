        ...
        >
          ...
          <div className="flex items-center justify-between px-5 py-3 text-white/80 text-sm shrink-0">
            <span className="truncate max-w-[50%] font-medium" title={current.originalFilename ?? undefined}>
              {current.originalFilename ?? t("components.imageGallery.image", { defaultValue: "Image" })}
            </span>
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                download={current.originalFilename ?? t("components.imageGallery.imageFilename", { defaultValue: "image" })}
          ...
          <div className="flex-1 flex items-center min-h-0">
            ...
            <div className="flex-1 flex items-center justify-center min-w-0 min-h-0 h-full px-2">
              <img
                ...
                alt={current.originalFilename ?? t("components.imageGallery.attachment", { defaultValue: "attachment" })}
