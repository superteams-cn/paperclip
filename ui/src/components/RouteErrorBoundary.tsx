      ...
      <div className="mx-auto max-w-2xl space-y-4 px-4 py-10">
        <div>
          <h1 className="text-lg font-semibold">
            {t("components.routeErrorBoundary.title", { defaultValue: "This page hit an error" })}
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            {t("components.routeErrorBoundary.description", {
              defaultValue:
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" onClick={this.props.onReset}>
            {t("components.routeErrorBoundary.goBackButton", { defaultValue: "Go back" })}
          </Button>
          <Button size="sm" onClick={() => window.location.reload()}>
            {t("components.routeErrorBoundary.reloadButton", { defaultValue: "Reload page" })}
          </Button>
        </div>
      </div>
    );
