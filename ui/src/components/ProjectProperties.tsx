                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="space-y-0.5">
                    <div className="flex items-center gap-2 text-sm font-medium">
                      <span>{t("components.projectProperties.enableIsolatedCheckouts", { defaultValue: "Enable isolated issue checkouts" })}</span>
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <div className="space-y-0.5">
                        <div className="flex items-center gap-2 text-sm">
                          <span>{t("components.projectProperties.defaultIsolatedCheckout", { defaultValue: "New issues default to isolated checkout" })}</span>
