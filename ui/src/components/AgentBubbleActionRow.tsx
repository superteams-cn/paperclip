    ...
    <>
      ...
      <Popover open={reasonOpen} onOpenChange={setReasonOpen}>
        ...
        <PopoverContent side="top" align="start" className="w-80 p-3">
          <div className="mb-2 text-sm font-medium">
            {t("components.agentBubbleActionRow.reasonPromptTitle", {
              defaultValue: "What could have been better?",
            })}
          </div>
          <Textarea
            value={downvoteReason}
            onChange={(event) => setDownvoteReason(event.target.value)}
            placeholder={t("components.agentBubbleActionRow.reasonPlaceholder", {
          ...
          <div className="mt-2 flex items-center justify-end gap-2">
            ...
            >
              {isSaving
                ? t("components.agentBubbleActionRow.saving", { defaultValue: "Saving..." })
                : t("components.agentBubbleActionRow.saveNote", { defaultValue: "Save note" })}
            </Button>
          </div>
        </PopoverContent>
      </Popover>
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {t("components.agentBubbleActionRow.sharingDialog.title", {
                defaultValue: "Save your feedback sharing preference",
              })}
            </DialogTitle>
            <DialogDescription>
              {t("components.agentBubbleActionRow.sharingDialog.description", {
                defaultValue:
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p>
              {t("components.agentBubbleActionRow.sharingDialog.savedLocally", {
                defaultValue: "This vote is always saved locally.",
              })}
            </p>
            <p>
              {t("components.agentBubbleActionRow.sharingDialog.chooseLeadIn", {
                defaultValue: "Choose",
              })}{" "}
              <span className="font-medium text-foreground">
                {t("components.agentBubbleActionRow.sharingDialog.alwaysAllow", {
                  defaultValue: "Always allow",
                })}
              </span>{" "}
              {t("components.agentBubbleActionRow.sharingDialog.alwaysAllowExplain", {
                defaultValue: "to share this vote and future voted AI outputs. Choose",
              })}{" "}
              <span className="font-medium text-foreground">
                {t("components.agentBubbleActionRow.sharingDialog.dontAllow", {
                  defaultValue: "Don't allow",
                })}
              </span>{" "}
              {t("components.agentBubbleActionRow.sharingDialog.dontAllowExplain", {
                defaultValue: "to keep this vote and future votes local.",
              })}
            </p>
            <p>
              {t("components.agentBubbleActionRow.sharingDialog.changeLater", {
                defaultValue: "You can change this later in Instance Settings > General.",
              })}
            </p>
            {termsUrl ? (
              <a
              ...
              >
                {t("components.agentBubbleActionRow.sharingDialog.readTerms", {
                  defaultValue: "Read our terms of service",
                })}
              </a>
            ) : null}
          </div>
