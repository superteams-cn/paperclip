    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          aria-label={t("components.search.searchSortMenu.sortResultsAria", { defaultValue: "Sort results" })}
        >
      ...
      <DropdownMenuContent align="end" className="w-48">
        <DropdownMenuLabel className="text-xs text-muted-foreground">
          {t("components.search.searchSortMenu.sortByLabel", { defaultValue: "Sort by" })}
        </DropdownMenuLabel>
        <DropdownMenuSeparator />
