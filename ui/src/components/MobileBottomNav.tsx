...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("nav.home", { defaultValue: "Home" }), icon: House },
      { type: "link", to: "/issues", label: t("nav.issues", { defaultValue: "Issues" }), icon: CircleDot },
      { type: "action", label: t("nav.create", { defaultValue: "Create" }), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("nav.agents", { defaultValue: "Agents" }), icon: Users },
      {
        type: "link",
        to: "/inbox",
