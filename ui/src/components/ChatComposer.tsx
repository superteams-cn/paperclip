...
export const ChatComposer = forwardRef<ChatComposerHandle, ChatComposerProps>(function ChatComposer(
  ...
  const placeholder =
    placeholderProp ?? t("components.chatComposer.placeholder", { defaultValue: "Message…" });
  const sendLabel =
    sendLabelProp ?? t("components.chatComposer.sendLabel", { defaultValue: "Send message" });
            ...
            const statusLabel =
              attachment.status === "uploading"
                ...
                : attachment.status === "error"
                  ? attachment.error ??
                    t("components.chatComposer.uploadFailed", { defaultValue: "Upload failed" })
                  : attachment.inline
                    ? t("components.chatComposer.statusInsertedInline", { defaultValue: "Inserted inline" })
