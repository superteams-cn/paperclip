...
export function SidebarStarredProjects() {
  ...
  return (
    <div
      ...
      aria-label={t("components.sidebarStarredProjects.ariaLabel", { defaultValue: "Starred projects" })}
    >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    ...
                    aria-label={t("components.sidebarStarredProjects.openActionsAria", { defaultValue: "Open actions for {{name}}", name: project.name })}
                  >
