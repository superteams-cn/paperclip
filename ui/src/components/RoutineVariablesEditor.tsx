      ...
      <CollapsibleTrigger className="flex w-full items-center justify-between px-3 py-2 text-left">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            {t("components.routineVariablesEditor.detected", {
              placeholder: "{{name}}",
              defaultValue: "Detected from `{{placeholder}}` placeholders in the title and instructions.",
            })}
          </p>
        </div>
  ...
  return (
    <>
      <div className="flex items-center justify-between gap-2 rounded-lg border border-dashed border-border/70 px-3 py-2 text-xs text-muted-foreground">
        <span>
          {t("components.routineVariablesEditor.hint", {
            placeholder: "{{variable_name}}",
            defaultValue: "Use `{{placeholder}}` placeholders in the title or instructions to prompt for inputs when the routine runs.",
          })}
        </span>
        <button
          type="button"
          ...
          <div className="space-y-5 text-sm">
            <section className="space-y-2">
              ...
              <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
                ...
                <li>
                  {t("components.routineVariablesEditor.rules.type", {
                    defaultValue:
                      "Pick a type (text, textarea, number, boolean, select, date), default value, and whether it is required.",
                  })}
                </li>
                <li>
                  {t("components.routineVariablesEditor.rules.dateInference", {
                    defaultValue:
