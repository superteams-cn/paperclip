...
const IssueTitleTextarea = memo(function IssueTitleTextarea({
  ...
  return (
    <textarea
      ...
      placeholder={t("pages.issues.newDialog.titlePlaceholder", { defaultValue: "Issue title" })}
      rows={1}
      value={draftValue}
      onChange={(e) => {
...
export function NewIssueDialog() {
  ...
  const createIssueErrorMessage =
    formatApiError(createIssue.error, t, t("pages.issues.newDialog.createError", { defaultValue: "Failed to create issue. Try again." }));
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border shrink-0">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>
              {isSubIssueMode
                ? t("pages.issues.newDialog.newSubIssue", { defaultValue: "New sub-issue" })
                : t("pages.issues.newDialog.newIssue", { defaultValue: "New issue" })}
            </span>
          </div>
              ...
              <Popover open={participantMenuOpen} onOpenChange={setParticipantMenuOpen}>
                <PopoverTrigger asChild>
                  <button
                    ...
                    title={t("pages.issues.newDialog.addReviewerOrApprover", { defaultValue: "Add reviewer or approver" })}
                  >
            ...
            <div className="max-w-full rounded-md border border-border bg-muted/30 px-2.5 py-1.5 text-xs text-muted-foreground">
              <div className="flex items-center gap-1.5">
                ...
                <span className="shrink-0">
                  {t("pages.issues.newDialog.subIssueOf", { defaultValue: "Sub-issue of" })}
                </span>
          ...
          {currentProject && currentProjectSupportsExecutionWorkspace && (
            ...
            <div className="space-y-1.5">
              ...
              {executionWorkspaceMode === "reuse_existing" && (
                ...
                >
                  <option value="">
                    {t("pages.issues.newDialog.chooseExistingWorkspace", { defaultValue: "Choose an existing workspace" })}
                  </option>
              ...
              {showParentWorkspaceWarning ? (
                <div className="rounded-md border border-amber-300/60 bg-amber-50 px-2 py-1.5 text-[11px] text-amber-900 dark:border-amber-800/70 dark:bg-amber-950/30 dark:text-amber-100">
                  {t("pages.issues.newDialog.parentWorkspaceWarning", {
                    ...
                    defaultValue: "Warning: this sub-issue will no longer use the parent issue workspace{{workspace}}.",
                  })}
                </div>
              ) : null}
            </div>
              ...
              <div className="mt-2 rounded-md border border-border p-3 bg-muted/20 space-y-3">
                <div className="space-y-1.5">
                  ...
                  {assigneeModelLane === "custom" && (
                    <p className="text-[11px] text-muted-foreground">
                      {t("pages.issues.newDialog.customModelHint", { defaultValue: "Override the model and effort for this issue only." })}
                    </p>
                  )}
                </div>
                {assigneeModelLane === "custom" && (
              ...
              {statuses.map((s) => (
                ...
                >
                  ...
                  <span className="flex flex-col text-left leading-tight">
                    ...
                    {s.description ? (
                      <span className="text-[10px] text-muted-foreground">{statusDescription(s.value, s.description)}</span>
                    ) : null}
                  </span>
                </button>
              ))}
          ...
          <Popover open={workModeOpen} onOpenChange={setWorkModeOpen}>
            <PopoverTrigger asChild>
              ...
              >
                ...
                {workModeLabel(currentWorkMode.value, currentWorkMode.label)}
              </button>
            </PopoverTrigger>
            <PopoverContent className="w-36 p-1" align="start">
              ...
              <span className="inline-flex items-center justify-center gap-1.5">
                ...
                <span>
                  {createIssue.isPending
                    ...
                    : isSubIssueMode
                      ? t("pages.issues.newDialog.createSubIssue", { defaultValue: "Create Sub-Issue" })
