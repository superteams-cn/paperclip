...
export function approvalTypeLabel(type: string, t?: TFunction): string {
  return t?.(`components.approvalPayload.typeLabels.${type}`, {
...
export function approvalLabel(type: string, payload?: Record<string, unknown> | null, t?: TFunction): string {
  const base = approvalTypeLabel(type, t);
  ...
  return (
    <div className="flex items-start gap-2">
      <span className="text-muted-foreground w-20 sm:w-24 shrink-0 text-xs pt-0.5">
        {t("components.approvalPayload.fields.skills", { defaultValue: "Skills" })}
      </span>
    ...
    <div className="mt-3 space-y-1.5 text-sm">
      <div className="flex items-center gap-2">
        <span className="text-muted-foreground w-20 sm:w-24 shrink-0 text-xs">
          {t("components.approvalPayload.fields.name", { defaultValue: "Name" })}
        </span>
        <span className="font-medium">{String(payload.name ?? "—")}</span>
      </div>
      <PayloadField label={t("components.approvalPayload.fields.role", { defaultValue: "Role" })} value={payload.role} />
      <PayloadField label={t("components.approvalPayload.fields.title", { defaultValue: "Title" })} value={payload.title} />
      <PayloadField label={t("components.approvalPayload.fields.icon", { defaultValue: "Icon" })} value={payload.icon} />
      {!!payload.capabilities && (
        <div className="flex items-start gap-2">
          <span className="text-muted-foreground w-20 sm:w-24 shrink-0 text-xs pt-0.5">
            {t("components.approvalPayload.fields.capabilities", { defaultValue: "Capabilities" })}
          </span>
      ...
      {!!payload.adapterType && (
        <div className="flex items-center gap-2">
          <span className="text-muted-foreground w-20 sm:w-24 shrink-0 text-xs">
            {t("components.approvalPayload.fields.adapter", { defaultValue: "Adapter" })}
          </span>
...
export function BudgetOverridePayload({ payload }: { payload: Record<string, unknown> }) {
  ...
  return (
    <div className="mt-3 space-y-1.5 text-sm">
      <PayloadField label={t("components.approvalPayload.fields.scope", { defaultValue: "Scope" })} value={payload.scopeName ?? payload.scopeType} />
      <PayloadField label={t("components.approvalPayload.fields.window", { defaultValue: "Window" })} value={payload.windowKind} />
      <PayloadField label={t("components.approvalPayload.fields.metric", { defaultValue: "Metric" })} value={payload.metric} />
  ...
  return (
    <div className="mt-4 space-y-3.5 text-sm">
      {title && (
        <div className="space-y-1">
          <p className="text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">
            {t("components.approvalPayload.fields.title", { defaultValue: "Title" })}
          </p>
      ...
      {summary && (
        <div className="space-y-1">
          <p className="text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">
            {t("components.approvalPayload.fields.summary", { defaultValue: "Summary" })}
          </p>
      ...
      {recommendedAction && (
        <div className="rounded-lg border border-amber-500/20 bg-amber-500/10 px-3.5 py-3">
          <p className="text-[11px] font-medium uppercase tracking-[0.08em] text-amber-700 dark:text-amber-300">
            {t("components.approvalPayload.fields.recommendedAction", { defaultValue: "Recommended action" })}
          </p>
      ...
      {nextActionOnApproval && (
        <div className="rounded-lg border border-border/60 bg-background/60 px-3.5 py-3">
          <p className="text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">
            {t("components.approvalPayload.fields.onApproval", { defaultValue: "On approval" })}
          </p>
      ...
      {risks.length > 0 && (
        <div className="space-y-1.5">
          <p className="text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">
            {t("components.approvalPayload.fields.risks", { defaultValue: "Risks" })}
          </p>
      ...
      {proposedComment && (
        <div className="space-y-1.5">
          <p className="text-[11px] font-medium uppercase tracking-[0.08em] text-muted-foreground">
            {t("components.approvalPayload.fields.proposedComment", { defaultValue: "Proposed comment" })}
          </p>
