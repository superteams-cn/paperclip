...
export function DashboardLive() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: t("pages.dashboardLive.liveRuns") },
    ]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return (
      <EmptyState
        icon={RadioTower}
        message={companies.length === 0 ? t("pages.dashboardLive.createCompany") : t("pages.dashboardLive.selectCompany")}
      />
    );
  }
  ...
  return (
    <div className="space-y-5">
      ...
      <ActiveAgentsPanel
        ...
        emptyMessage={t("pages.dashboardLive.empty")}
