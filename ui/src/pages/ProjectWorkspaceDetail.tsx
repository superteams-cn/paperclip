    ...
    onSuccess: (result, request) => {
      ...
      setRuntimeActionMessage(
        request.action === "run"
          ...
          : request.action === "stop"
            ? t("pages.projectWorkspaceDetail.runtime.serviceStopped", { defaultValue: "Workspace service stopped. Task execution is not paused." })
            : request.action === "restart"
              ? t("pages.projectWorkspaceDetail.runtime.serviceRestarted", { defaultValue: "Workspace service restarted. Task execution is not paused." })
