...
export function UserSecretChip({ className, label }: { className?: string; label?: string }) {
  ...
  const resolvedLabel =
    label ?? t("pages.secrets.userSecretPresentation.userSecretChip.label", { defaultValue: "User secret" });
  return (
...
export function myValueLabel(state: MyValueState): string {
  switch (state) {
    case "set":
      return t("pages.secrets.userSecretPresentation.myValue.set", { defaultValue: "Value set" });
    case "not_set":
      return t("pages.secrets.userSecretPresentation.myValue.notSet", { defaultValue: "Not set" });
    case "inactive":
      return t("pages.secrets.userSecretPresentation.myValue.inactive", { defaultValue: "Disabled" });
  }
}
...
export function coverageSummaryLabel(summary: UserSecretCoverageSummary | undefined): string {
  ...
  return t("pages.secrets.userSecretPresentation.coverage.summary", {
