        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(360px,0.85fr)]">
          <section className={`${panelClassName} space-y-6`}>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="border border-zinc-800 p-3">
                <div className="text-xs uppercase tracking-[0.2em] text-zinc-500">{t("common.company", { defaultValue: "Company" })}</div>
                <div className="mt-1 text-sm text-zinc-100">{companyDisplayName}</div>
              </div>
              <div className="border border-zinc-800 p-3">
                <div className="text-xs uppercase tracking-[0.2em] text-zinc-500">{t("pages.inviteLanding.invitedBy", { defaultValue: "Invited by" })}</div>
              ...
              <div className="border border-zinc-800 p-3">
                <div className="text-xs uppercase tracking-[0.2em] text-zinc-500">{t("pages.inviteLanding.requestedAccess", { defaultValue: "Requested access" })}</div>
              ...
              <div className="border border-zinc-800 p-3">
                <div className="text-xs uppercase tracking-[0.2em] text-zinc-500">{t("pages.inviteLanding.inviteExpires", { defaultValue: "Invite expires" })}</div>
            ...
            {inviteMessage ? (
              <div className="border border-amber-500/40 bg-amber-500/10 p-4">
                <div className="text-xs uppercase tracking-[0.2em] text-amber-200/80">{t("pages.inviteLanding.messageFromInviter", { defaultValue: "Message from inviter" })}</div>
                ...
                <div>
                  <h2 className="text-lg font-semibold">
                    {shouldAutoAcceptHumanInvite
                      ? t("pages.inviteLanding.submittingJoinRequest", { defaultValue: "Submitting join request" })
                      : invite.inviteType === "bootstrap_ceo"
                  ...
                  <p className="mt-1 text-sm text-zinc-400">
                    {shouldAutoAcceptHumanInvite
                      ? t("pages.inviteLanding.submittingForCompany", {
                      ...
                      : invite.inviteType === "bootstrap_ceo"
                        ...
                        : t("pages.inviteLanding.companyAcceptDescription", {
