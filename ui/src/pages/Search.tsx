      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-4 px-4 py-10 sm:px-6">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {t("pages.search.initialDescription")}
          </p>
        </div>
        ...
        <ul className="space-y-1 text-xs text-muted-foreground">
          <li>
            <span className="font-medium text-foreground">{t("pages.search.tips.identifierLabel")}</span> {t("pages.search.tips.identifierPrefix")}{" "}
            <code className="rounded bg-muted px-1 py-0.5 text-[11px]">PAP-123</code> {t("pages.search.tips.identifierSuffix")}
          </li>
          <li>
    ...
    return (
      <div className="mx-auto flex w-full max-w-xl flex-col items-center justify-center gap-3 px-4 py-12 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          {status ? t("pages.search.serverReturned", { status }) : t("pages.search.requestFailed")} {t("pages.search.retryHint")}
        </p>
        <div className="flex flex-wrap items-center justify-center gap-2">
          ...
          <Button onClick={navigateIssuesFallback} variant="outline" size="sm">
            {t("pages.search.openIssuesFilter")}
          </Button>
        </div>
      </div>
    );
      ...
      <div className="mx-auto flex w-full max-w-xl flex-col items-center justify-center gap-3 px-4 py-12 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          ...
          <Button onClick={openNewIssue} size="sm" variant="default">
            ...
            {t("pages.search.createIssueFromQuery")}
          </Button>
  ...
  return (
    <div className="flex w-full max-w-[960px] flex-col px-2 sm:px-4" data-testid="search-results">
      <div className="flex items-center justify-between py-2 text-[11px] uppercase tracking-wide text-muted-foreground">
        <span>
          {t("pages.search.resultCount", { count: totalResults })} · {t("pages.search.sortedByRelevance")}
        </span>
