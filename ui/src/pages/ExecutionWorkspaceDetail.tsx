      ...
      <div className="space-y-4 overflow-hidden sm:space-y-6">
        ...
        {activeTab === "services" ? (
          ...
          <div className="space-y-4 sm:space-y-6">
            <Card className="rounded-none">
              <CardHeader>
                ...
                <CardDescription>
                  {t("pages.executionWorkspace.settings.description", { defaultValue: "Edit the concrete path, repo, branch, provisioning, teardown, and runtime overrides attached to this execution workspace. Saved changes affect future runs; Paperclip may refresh or replace a reused workspace when config changes." })}
                </CardDescription>
                <CardAction>
                  <Button
                    variant="destructive"
                ...
                <div className="space-y-4">
                  ...
                  {configuredRuntimeServicePorts.length > 0 ? (
                    <div className="space-y-3 rounded-md border border-border bg-muted/20 p-4">
                      <div>
                        <div className="text-sm font-medium">{t("pages.executionWorkspace.settings.servicePorts", { defaultValue: "Service ports" })}</div>
                        <p className="mt-1 text-sm text-muted-foreground">
                          {t("pages.executionWorkspace.settings.servicePortsDescription", { defaultValue: "Set a fixed port for a service or leave it blank to use its configured automatic behavior. Editing an inherited service creates an execution-workspace runtime override." })}
                        </p>
                      </div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {t("pages.executionWorkspace.settings.servicePortsRecheckHint", { defaultValue: "Paperclip checks fixed ports again when a service starts and rejects cross-workspace conflicts." })}
                      </p>
                    </div>
                  ) : null}
                </div>
            ...
            <Card className="rounded-none">
              ...
              <DetailRow label={t("pages.executionWorkspace.fields.sourceIssue", { defaultValue: "Source task" })}>
                {sourceIssue ? (
          ...
          <MissingPluginTabPlaceholder
            ...
            defaultTabLabel={t("pages.executionWorkspace.backToIssues", { defaultValue: "Back to tasks" })}
          />
        ) : activeTab === "routines" ? (
