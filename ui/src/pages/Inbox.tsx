...
export function Inbox() {
  ...
  const archiveIssueMutation = useMutation({
    ...
    onError: (err, id, context) => {
      setActionError(formatApiError(err, t, t("pages.inbox.errors.archiveIssue", { defaultValue: "Failed to archive issue" })));
                ...
                <PopoverContent align="end" className="w-40 p-2">
                  <div className="space-y-0.5">
                    {([
                      ...
                      ["assignee", t("pages.inbox.groupOptions.assignee", { defaultValue: "Assignee" })],
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="issues_i_touched">{t("pages.inbox.categories.issuesITouched", { defaultValue: "My recent issues" })}</SelectItem>
