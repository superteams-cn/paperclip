      ...
      <Card className="gap-4 border-border/70 bg-background/85 py-0">
        ...
        <CardContent className="space-y-3 px-5 pb-5 pt-0 text-sm text-muted-foreground">
          <div className="rounded-2xl border border-border/70 bg-background/80 px-4 py-3">
            ...
            {t("pages.uxLabs.systemNotice.notes.componentUse")} <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-[12px]">{`<SystemNotice />`}</code>{" "}
            {t("pages.uxLabs.systemNotice.notes.from")} <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-[12px]">@/components/SystemNotice</code>.
            {t("pages.uxLabs.systemNotice.notes.itAccepts")} <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-[12px]">tone</code>,{" "}
