  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="text-sm font-semibold text-foreground">{t("apps.storeCards.connectOwn")}</div>
        <div className="text-xs text-muted-foreground">
          {t("apps.storeCards.connectOwnDescription")}
        </div>
      </div>
      <span className="shrink-0 text-xs font-semibold text-primary">{t("apps.storeCards.connectAction")}</span>
    </button>
  );
}
...
export function AdvancedToolsLink() {
  ...
  return (
    ...
    >
      ...
      {t("apps.storeCards.developerTools")}
    </Link>
  );
}
