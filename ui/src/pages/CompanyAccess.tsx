            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {t("pages.companyAccess.pendingHumanJoinsDescription", { defaultValue: "Review pending join requests before they become active company members." })}
                </p>
              </div>
            ...
            <div className="space-y-5">
              <div className="rounded-lg border border-border px-3 py-3">
                ...
                <div className="mt-2 text-sm text-muted-foreground">
                  {assignedIssuesQuery.isLoading
                    ? t("pages.companyAccess.checkingAssignedIssues", { defaultValue: "Checking assigned tasks..." })
                    : t("pages.companyAccess.openAssignedIssues", {
                      defaultValue: "{{count}} open assigned task",
              ...
              {assignedIssues.length > 0 ? (
                <div className="space-y-2">
                  <div className="text-sm font-medium">{t("pages.companyAccess.issueReassignment", { defaultValue: "Task reassignment" })}</div>
                  <select
